	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(main/imagesimg_bg_5.jpg);">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 room-wrap animate-box">
						<a href="main/imagesroom-1.jpg" class="room image-popup-link" style="background-image: url(main/imagesroom-1.jpg);"></a>
					...
					<div class="col-md-4 room-wrap animate-box">
						<a href="main/imagesroom-2.jpg" class="room image-popup-link" style="background-image: url(main/imagesroom-2.jpg);"></a>
						<div class="desc text-center">
					...
					<div class="col-md-4 room-wrap animate-box">
						<a href="main/imagesroom-3.jpg" class="room image-popup-link" style="background-image: url(main/imagesroom-3.jpg);"></a>
						<div class="desc text-center">
							<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
					...
					<div class="col-md-4 room-wrap animate-box">
						<a href="main/imagesroom-4.jpg" class="room image-popup-link" style="background-image: url(main/imagesroom-4.jpg);"></a>
						<div class="desc text-center">
							<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
					...
					<div class="col-md-4 room-wrap animate-box">
						<a href="main/imagesroom-5.jpg" class="room image-popup-link" style="background-image: url(main/imagesroom-5.jpg);"></a>
						<div class="desc text-center">
							<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
					...
					<div class="col-md-4 room-wrap animate-box">
						<a href="main/imagesroom-6.jpg" class="room image-popup-link" style="background-image: url(main/imagesroom-6.jpg);"></a>
						<div class="desc text-center">
							<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
		...
		<div id="colorlib-subscribe" style="background-image: url(main/imagesimg_bg_2.jpg);">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
