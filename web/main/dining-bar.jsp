			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4 room-wrap animate-box">
						<a href="main/images/menu-1.jpg" class="room image-popup-link" style="background-image: url(main/images/menu-1.jpg);"></a>
					...
					<div class="col-md-4 room-wrap animate-box">
						<a href="main/images/menu-2.jpg" class="room image-popup-link" style="background-image: url(main/images/menu-2.jpg);"></a>
						<div class="desc text-center">
