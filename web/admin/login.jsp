<%-- 
    Document   : login
    Created on : Aug 7, 2019, 9:18:54 PM
    Author     : Chi Trung
--%>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <div class="form-group">
                      <input type="password"  name="txtPassword" class="form-control form-control-user" id="exampleInputPassword" placeholder="Mật khẩu">
                    </div>
                    <div class="form-group">
                        ...
                        <hr>
                        <button type="submit" value="Login" class="btn btn-success btn-user btn-block">Đăng Nhập </button>                                    
                  </form>
